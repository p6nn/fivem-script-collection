...
Config.Locale = {
    ...
    impoundError = "Failed to impound vehicle",
    retrieveSuccess = "Vehicle retrieved successfully",
    retrieveError = "Failed to retrieve vehicle",
    insufficientFunds = "Insufficient funds to retrieve vehicle",
    noPermission = "You don't have permission to do this",
    vehicleNotFound = "Vehicle not found",
    ownerNotified = "Vehicle owner has been notified",
    impoundNotification = "Your vehicle with plate %s has been impounded. Reason: %s",
    noAvailableSpawn = "No available spawn points at this impound lot"
}
